create sequence client_sequence start with 1 increment by 50;
...
(
    id        bigint not null primary key default nextval('address_sequence'),
    street    varchar(50),
    client_id bigint,
...
create table phone
(
    id        bigint not null primary key default nextval('phone_sequence'),
    number    varchar(50),
    client_id bigint,
