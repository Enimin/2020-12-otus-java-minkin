...
import ru.rt.core.repository.executor.DbExecutorImpl;
import ru.rt.core.sessionmanager.TransactionManagerJdbc;
import ru.rt.crm.datasource.DriverManagerDataSource;
import ru.rt.crm.model.Client;
import ru.rt.crm.model.Manager;
import ru.rt.crm.service.DbServiceClientImpl;
import ru.rt.crm.service.DbServiceManagerImpl;
import ru.rt.jdbc.mapper.*;
...
public class HomeWork18 {
    ...
    private static final Logger log = LoggerFactory.getLogger(HomeWork18.class);
...
// Работа с клиентом
        ...
        var dataTemplate = new DataTemplateJdbc<Client>(dbExecutor, entitySQLMetaDataClient, entityClassMetaDataClient);
